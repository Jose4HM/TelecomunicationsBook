...
\begin{equation}
\frac{C}{N_0}_1=P_t\cdot G_A\cdot\frac{1}{L_p1}\cdot\frac{G}{T}_{1}\cdot\frac{1}{K}
\label{eq:1}
\end{equation}
$L_p$: Pérdidas por propagación.\\
Expresando la ecuación \ref{eq:1} en decibelios:
\begin{equation}
\frac{C}{N_0}_1=PIRE_1-L_{p1}+\frac{G}{T}_1-10\log k
\label{eq:2}
\end{equation}
...
\begin{equation}
\frac{C}{N_0}_t=10\log\corchetes{\frac{1}{antilog\parentesis{\frac{C}{N_0}}_1}+\frac{1}{antilog\parentesis{\frac{C}{N_0}}_intermodulación}+\frac{1}{antilog\parentesis{\frac{C}{N_0}}_2}+\frac{1}{antilog\parentesis{\frac{C}{X}}_interferencias}}^{-1} dBHz
\end{equation}
